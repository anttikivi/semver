...
var parserTests = []struct {
	...
	{"semver0.0.0", nil, true},
	{"semver0.0.0-alpha", nil, true},
	{"semver0.0.0+build", nil, true},
	{"semver0.0.0-alpha+build", nil, true},
}

var laxParserTests = []struct {
	v       string
	want    *semver.Version
	wantErr bool
}{
	...
	{"1.2.3-pre.hello,wrong", nil, true},
	{"bad", nil, true},
	{"1-alpha.beta.gamma", newVersion(1, 0, 0, newPrerelease("alpha", "beta", "gamma")), false},
	{"1-pre", newVersion(1, 0, 0, newPrerelease("pre")), false},
	{"1+meta", newVersion(1, 0, 0, newPrerelease(), "meta"), false},
	{"1-pre+meta", newVersion(1, 0, 0, newPrerelease("pre"), "meta"), false},
	{"1.2-pre", newVersion(1, 2, 0, newPrerelease("pre")), false},
	{"1.2+meta", newVersion(1, 2, 0, newPrerelease(), "meta"), false},
	{"1.2-pre+meta", newVersion(1, 2, 0, newPrerelease("pre"), "meta"), false},
	{"1.0.0-alpha", newVersion(1, 0, 0, newPrerelease("alpha")), false},
	{"1.0.0-alpha.1", newVersion(1, 0, 0, newPrerelease("alpha", 1)), false},
	{"1.0.0-alpha.beta", newVersion(1, 0, 0, newPrerelease("alpha", "beta")), false},
	{"1.0.0-beta", newVersion(1, 0, 0, newPrerelease("beta")), false},
	...
	{"1.0.0-beta.11", newVersion(1, 0, 0, newPrerelease("beta", 11)), false},
	{"1.0.0-rc.1", newVersion(1, 0, 0, newPrerelease("rc", 1)), false},
	{"1", newVersion(1, 0, 0, newPrerelease()), false},
	{"1.0", newVersion(1, 0, 0, newPrerelease()), false},
	{"1.0.0", newVersion(1, 0, 0, newPrerelease()), false},
	{"1.2", newVersion(1, 2, 0, newPrerelease()), false},
	{"1.2.0", newVersion(1, 2, 0, newPrerelease()), false},
	{"1.2.3-456", newVersion(1, 2, 3, newPrerelease(456)), false},
	{"1.2.3-456.789", newVersion(1, 2, 3, newPrerelease(456, 789)), false},
	{"1.2.3-456-789", newVersion(1, 2, 3, newPrerelease("456-789")), false},
	...
	{"1.02", nil, true},
	{"01.02", nil, true},
	{"0.0.0", newVersion(0, 0, 0, newPrerelease()), false},
	{"0.0.0-alpha", newVersion(0, 0, 0, newPrerelease("alpha")), false},
	{"0.0.0+build", newVersion(0, 0, 0, newPrerelease(), "build"), false},
	{"0.0.0-alpha+build", newVersion(0, 0, 0, newPrerelease("alpha"), "build"), false},
	...
	{"v", nil, true},
	{"vbad", nil, true},
	{"v1-alpha.beta.gamma", newVersion(1, 0, 0, newPrerelease("alpha", "beta", "gamma")), false},
	{"v1-pre", newVersion(1, 0, 0, newPrerelease("pre")), false},
	{"v1+meta", newVersion(1, 0, 0, newPrerelease(), "meta"), false},
	{"v1-pre+meta", newVersion(1, 0, 0, newPrerelease("pre"), "meta"), false},
	{"v1.2-pre", newVersion(1, 2, 0, newPrerelease("pre")), false},
	{"v1.2+meta", newVersion(1, 2, 0, newPrerelease(), "meta"), false},
	{"v1.2-pre+meta", newVersion(1, 2, 0, newPrerelease("pre"), "meta"), false},
	{"v1.0.0-alpha", newVersion(1, 0, 0, newPrerelease("alpha")), false},
	{"v1.0.0-alpha.1", newVersion(1, 0, 0, newPrerelease("alpha", 1)), false},
	{"v1.0.0-alpha.beta", newVersion(1, 0, 0, newPrerelease("alpha", "beta")), false},
	{"v1.0.0-beta", newVersion(1, 0, 0, newPrerelease("beta")), false},
	...
	{"v1.0.0-beta.11", newVersion(1, 0, 0, newPrerelease("beta", 11)), false},
	{"v1.0.0-rc.1", newVersion(1, 0, 0, newPrerelease("rc", 1)), false},
	{"v1", newVersion(1, 0, 0, newPrerelease()), false},
	{"v1.0", newVersion(1, 0, 0, newPrerelease()), false},
	{"v1.0.0", newVersion(1, 0, 0, newPrerelease()), false},
	{"v1.2", newVersion(1, 2, 0, newPrerelease()), false},
	{"v1.2.0", newVersion(1, 2, 0, newPrerelease()), false},
	{"v1.2.3-456", newVersion(1, 2, 3, newPrerelease(456)), false},
	{"v1.2.3-456.789", newVersion(1, 2, 3, newPrerelease(456, 789)), false},
	{"v1.2.3-456-789", newVersion(1, 2, 3, newPrerelease("456-789")), false},
	...
	{"v1.02", nil, true},
	{"v01.02", nil, true},
	{"v0.0.0", newVersion(0, 0, 0, newPrerelease()), false},
	{"v0.0.0-alpha", newVersion(0, 0, 0, newPrerelease("alpha")), false},
	{"v0.0.0+build", newVersion(0, 0, 0, newPrerelease(), "build"), false},
	{"v0.0.0-alpha+build", newVersion(0, 0, 0, newPrerelease("alpha"), "build"), false},
