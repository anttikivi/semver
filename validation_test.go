...
func TestIsValidPartialPrefix(t *testing.T) {
	t.Parallel()
	...
	tests := []struct {
		...
		{"semverbad", false},
		{"semver1-alpha.beta.gamma", true},
		{"semver1-pre", true},
		{"semver1+meta", true},
		{"semver1-pre+meta", true},
		{"semver1.2-pre", true},
		{"semver1.2+meta", true},
		{"semver1.2-pre+meta", true},
		{"semver1.0.0-alpha", true},
		{"semver1.0.0-alpha.1", true},
		{"semver1.0.0-alpha.beta", true},
		{"semver1.0.0-beta", true},
	...
	for _, tt := range tests {
		...
		t.Run(name, func(t *testing.T) {
			...
			if ok := semver.IsValidPartialPrefix(tt.v, "semver", "se"); ok != tt.want {
				t.Errorf(
					"IsValidPartialPrefix(%q, %q, %q) = %v, want %v",
					tt.v,
					"semver",
					"se",
					ok,
